...
const permissionList = require('../../constants/permissions');
...
module.exports = {
	...
	delete: req => Role.remove(req.params.id),
	...
	listAllPermissions: () => {
		const permissions = Object.values(permissionList);
		const perm = permissions.map(p => {
